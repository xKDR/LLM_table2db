...
**Contract:** For each page, return **one JSON object** with **three pipe-delimited table strings**. If a specific table archetype isn't present on the page, return `""` (an empty string) for that key.
...
> **Note:** Karnataka budget documents typically contain three table archetypes: Sub-Major Head summaries, Minor Head summaries, and Object Head detail tables. Sub-Head and Detailed-Head standalone summary tables are not present in these documents.
...
**Minor Head Summary Table (→ minor_head_summary_csv):**
- Lists multiple 3-digit codes (001, 102, 190, 196, etc.) in the leftmost column
- Each row shows a single total per Minor Head
- Typically appears early in a demand (pages 2-5)
- Row descriptions are Minor Head names, not Object Head descriptions
...
- Totals appear as "Total XX" rows within the table
...
|-------------|----------|-----------|
| Total 01 | Total | Detailed-Head |
| Total 05 | Total | Detailed-Head |
| Total 196-1 | Total | Sub-Head |
| Total 196 | Total | Minor-Head |
| Total 2225 | Total | Major-Head |
...
### `sub_major_head_summary_csv`
```
Source_Page_Number|Volume_Number|Demand_Number|Major_Head_Code|Major_Head_Name|Sub_Major_Head_Code|Sub_Major_Head_Name|Full_Account_Code|Description|Vote_Charge_Marker|Row_Type|Row_Level|Financial_Col_1|Financial_Col_2|Financial_Col_3|Financial_Col_4
```

### `minor_head_summary_csv`
```
Source_Page_Number|Volume_Number|Demand_Number|Major_Head_Code|Major_Head_Name|Sub_Major_Head_Code|Sub_Major_Head_Name|Minor_Head_Code|Minor_Head_Name|Full_Account_Code|Description|Vote_Charge_Marker|Row_Type|Row_Level|Financial_Col_1|Financial_Col_2|Financial_Col_3|Financial_Col_4
```
...
- The JSON must contain **exactly three keys**: `sub_major_head_summary_csv`, `minor_head_summary_csv`, and `object_head_summary_csv`.
